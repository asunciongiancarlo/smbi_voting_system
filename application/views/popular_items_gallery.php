<div>
 <?php 
	...
	foreach($items as $i){
	extract($i);
	$sql = $CI->db->query("SELECT image FROM items_images WHERE id = (SELECT ID FROM items_images WHERE itemID = $itemID AND defaultStatus = 1) LIMIT 1");
	...
	?>
		...
		<div class="common-gal fl gallery-item" style='height:290px;overflow:hidden;'>
			<div class="common-gal-heading" style='text-align:center;height:25px;background:#999999;color:white;font-style:bold;'> 
			...
			<div class="clear"></div>
			 ...
			 <div class="clear"  style='border-bottom:1px solid #eeeeee;height:160px;text-align:center;width:210px;overflow:hidden'>
				 <table>
				 <tr>
					<td class='gal-Icon-Container'><a href="<?php echo HTTP_PATH.'gallery/itemInfo2/'.$itemID .'/pi' ?>"><img class='gal-Icon-Img' src="<?php echo HTTP_PATH?>img/galleryImg/<?php echo $item_img ?>" style='<?php echo $w ?>'></a></td>
				 </tr>	
				</table> 
			 </div>
			 <div style='text-align:center;'>
				...
				<label class='dateReleased'>Date Published: <?php echo date("M d, Y", strtotime($dateReleased));?><label>
