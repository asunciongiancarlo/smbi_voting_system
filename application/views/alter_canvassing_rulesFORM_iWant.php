...
<?php 
		...
		$action = HTTP_PATH."iWantCampaign/alter_canvassing_rules/update/$campaignID";
		$CI2 =& get_instance();
		$CI2->load->library('fv');
		...
		$iLikeCanvassingRules = $CI->db->query("SELECT typeName, i.fieldID as POSM_TypeID ,extra_label, i.price_rangeID as priceID , 
			   ...
			   FROM iWantCanvassingRulesRef as i 
...
<div class="content">
	...
	<div class="title-content">
		<h2>Alter <span style='text-transform: lowercase;'>i</span>Want Canvassing Rules</h2>
	</div>
