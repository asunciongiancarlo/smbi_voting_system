		...
		<div class="common-gal fl gallery-item" style='height:290px;overflow:hidden;'>
			...
			<div class="clear"></div>
			 ...
			 <div class="clear"  style='border-bottom:1px solid #eeeeee;height:160px;text-align:center;width:210px;overflow:hidden'>
				 <table>
				 <tr>
					<td class='gal-Icon-Container'><a href="<?php echo HTTP_PATH.'gallery/itemInfo2/'.$itemID .'/m' ?>"><img class='gal-Icon-Img' src="<?php echo HTTP_PATH?>img/galleryImg/<?php echo $item_img ?>" style='<?php echo $w ?>'></a></td>
				 </tr>	
				</table> 
			 </div>
