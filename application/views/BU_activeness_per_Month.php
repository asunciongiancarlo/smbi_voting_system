<div class="content">
	...
	<div class="title-content">
		<h2>ACTIVENESS OF BUSINESS UNITS PER MONTH</h2>
	</div>
	...
	<div class="working_area">
		...
		<div class='fl  searhPanel' style='width:174%;margin-top:-20px;'>
		      <form name='BU_activeness' action='<?php echo HTTP_PATH ."report/BU_activeness_per_Month/$countryID/$cyear" ?>' method='post'>
				...
				<tr>
				  ...
				  <td style='text-align:center;'>					<?php echo $month  ?> 		</td>			  
					 ...
					 <td style='text-align:center;'>				
						<?php echo number_format($target); 				$total_target += $target;  ?> 
					 </td>
					 <td style='text-align:center;'>					
				  ...
				  <td style='text-align:center;'>	
					<a href='<?php echo HTTP_PATH."report/BU_items/gMonth/$cID/$mID/$year"; ?>' style='cursor:pointer;'> View Items 			</a> |
					<a href='<?php echo HTTP_PATH."report/item_division/gMonth/$cID/$year/$mID"; ?>' style='cursor:pointer;'> Distribution </a> 
				  </td>
				</tr>
				 <?php } ?>
				</tbody>
