...
<form name='frmSearch' method='POST' action='<?php echo $searchAction ?>'> 
	...
	<div class="filter items-fil" style='height:28px;margin-top:5px;margin-bottom:1px;'  > 
		<img src='<?php echo HTTP_PATH.'img/red_filter.jpg'; ?>' onclick="viewfilter()" style="margin-top: -50px;">
	</div>
				...
				<br/>
					   <select class='sel' name='selPOSMType' >
						...
						<table>
							<tr>
								<td class='dateParam'>
								<select name='year' class='range sel'>
								<?php
								...
								<td class='dateParam'>
								<select name='month' class='range sel'>
								<?php
									for($i=0;$i<=12;$i++)
									{	
