...
?>
		<div class='fl  searhPanel' style='width:174%;margin-top:-20px;'>
			  ...
			  <select name='countryID' style='width:25%;margin-right:10px;' disabled>
			   ...
			   <div style='clear:both'></div>
			   <!-- POSMTypeID -->
			   <?php if((isset($iLikeCampaignRulesID) AND $fieldName=='POSMTypeID')){ ?>
			   <select name='POSMTypeID' class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
				...
				<div style='clear:both;'></div>
				 ...
				 <!-- POSMStatusID -->
				<?php if((isset($iLikeCampaignRulesID) AND $fieldName=='POSMStatusID')){ ?> 
				<select name='POSMStatusID' class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
				...
				<!-- OUTLETsTATUSID -->
				<?php if((isset($iLikeCampaignRulesID) AND $fieldName=='OUTLETStatusID')){ ?> 
				 <select name='OUTLETStatusID' class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
				...
				<!-- PremiumTypeID -->
				<?php if((isset($iLikeCampaignRulesID) AND $fieldName=='PremiumTypeID')){ ?> 
				 <select name='PremiumTypeID' class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
				...
				<!-- MaterialTypeID -->
				<?php if((isset($iLikeCampaignRulesID) AND $fieldName=='MaterialTypeID')){ ?> 
				<select name='MaterialTypeID'  class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
				...
				<!-- brandID -->
				<?php if((isset($iLikeCampaignRulesID) AND $fieldName=='brandID')){ ?> 
				<select name='brandID' class='fl' style='width:25%;margin-right:10px;' data-parsley-trigger="change" data-parsley-required="true" placeholder="Required field">
