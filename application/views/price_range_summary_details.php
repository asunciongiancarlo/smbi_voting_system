<div class="content" style="width: 112%;margin-left: -6%;">
	...
	<div class="title-content">
		<h2> Price Category Summary In Details</h2>
	</div>
	...
	<div class="working_area" style="min-height:816px;">
		...
		//print_r($POST);
		?>
		   <form name="SMBi2" id="statusTable" action='<?php echo HTTP_PATH."report2/price_range_summary_details/$FORMcID/pstatusID/$POSM_StatusID/$FORMfldName/$FORMfldVal/$FORMpriceRangeID/$DateFrom/$DateTo" ?>' method="POST"> 
