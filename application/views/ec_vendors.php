    <div class="content">
    	...
    	<div class="title-content fl">
        	<h2> <span style='text-transform:lowercase;'>e</span>CATALOGUE VENDORS </h2>
        </div>
		...
		<?php if($ADD){ ?>
			<div class="sub-link">
				<ul>
					<li><a href="<?php echo HTTP_PATH ."eCatalog/vendors/add" ?>"> <img src="<?php echo HTTP_PATH ?>img/plus.png" width="31" height="31"> </a></li>
					<li><a href="<?php echo HTTP_PATH ."eCatalog/vendors/add" ?>"> <h5>Add<br/>Vendor</h5> </a></li>
				</ul>
			</div>	
		<?php
			}
		...
		<div class="info-company" style="display:none" id='info_company<?php echo $j++ ?>'>
			<table border="0" style="background:#f0f8ff;">
				...
				<tr>
					...
					<td>
						<div class="button-content4">
							<a href=""><a href="<?php echo HTTP_PATH ."eCatalog/vendors/duplicate/".$id ?>"><h2>DUPLICATE</h2></a></a>
						</div>
					</td>
					<?php } ?>
				</tr>
				<tr>
					...
					<td>
						<div class="button-content4">
							<a href=""><a href="<?php echo HTTP_PATH ."eCatalog/vendors/edit/".$id ?>"><h2>EDIT</h2></a></a>
						</div>
					</td>
					<?php } if($DELETE){ ?>
					<td>
						<div class="button-content4" onclick="deleteOneItem('<?php echo $id ?>')">
							<h2>DELETE</h2>
						</div>
					</td>
					<?php } ?>
	...
	function deleteOneItem(id)
	{
		jConfirm("Are you sure you want to delete this Vendor?","Alert",function(r){
			if(r) window.location = "<?php echo HTTP_PATH ?>eCatalog/vendors/deleteOneItem/"+ id;
		});
	}
	...
	<?php if($last>0){ ?>
		<ul class="pagination">
				<a href="<?php echo HTTP_PATH."eCatalog/vendors/page/1" ?>"><li class="page-btn" style="margin-right:2px;"> &laquo; FIRST </li></a> 
				<?php 
					//PAGNINATION
					$i	   = 1; 
					$page  = 1;
					...
					while($l!=0)
					{
						...
						//ACTIVE PAGE
						$style="";
						$page_link = HTTP_PATH."eCatalog/vendors/page/".$i++;
						if($active_page==$page++)
						{
				...
				?>
				<a href="<?php echo HTTP_PATH."eCatalog/vendors/page/".$last ?>"><li class="page-btn">LAST &raquo;</li></a>
		</ul>
	<?php } ?>
    </div>
