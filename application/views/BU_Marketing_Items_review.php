<div class="content" style='padding-left:1px;'>
	<div class="title-content" style='width:100%;'>
		<h2  class="item-galla" style='width:40%;float:left;'><span>BU Marketing:</span><span class="titleNext"> Items Review</span></h2>
	...
	<div>
		...
		<div  style="font-weight:bold; font-size:15px;" class="container">
			...
			?>
			<div class="row1">
			<form name="SMBi2" id="itemsForm" action="<?php echo HTTP_PATH ?>itemDatabase/tag_for_purging/BU_Marketing_Items_review/purgeSelectedItems" method="POST" style="margin-left: 18px;"> 
			<?php 		
						...
						<div class="clear"></div>
						 ...
						 echo "<label style='font-size:10px;text-align:center;margin-bottom:-15px;'>" ;
								...
								if(($EDIT & $_SESSION['super_admin']!='y') OR ($VENDORS_EDIT & $_SESSION['super_admin']!='y'))	
									echo "<a href='".HTTP_PATH."itemDatabase/BU_Marketing_Items_review/edit/".$itemID."'>Edit</a> |";
	...
	<script type="text/javascript">
		...
		function deleteOneItem(id)
		{
			jConfirm("Are you sure you want to submit this item for purging?","Alert",function(r){
				if(r) window.location = "<?php echo HTTP_PATH ?>itemDatabase/tag_for_purging/BU_Marketing_Items_review/purgeOneItem/"+ id;
			});
		}
