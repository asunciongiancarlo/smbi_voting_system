...
<script>
  ...
  function finish()
	 ...
	 function submit()
	   {
	    jConfirm("Are you sure you want to submit your votes for iLike Campaign?<br/>Click Ok to proceed.","Message Confirmation",function(r) {if(r)goSubmit()});
	   ...
	   if(isThereAnError){ 
	      jAlert('Please vote on all the items to proceed. Highlighted in red are the items that need your vote.');
		   ...
		   if(<?php echo $min_number_of_votes ?> > curVotes){
			  ...
			  $.alerts.cancelButton  = 'View LIKED Items';
			  ...
			  jAlert('<br/>Sorry you were not able to meet the rules. You have liked  '+ curVotes  + ' items. You need to like ' + iLikesCurRules3  + ' items.','Alert');
		   }
	   }else{
	     return true; 
	   }
