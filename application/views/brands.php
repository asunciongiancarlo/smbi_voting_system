    <div class="content">
        ...
        <div class="working_area">
			...
			if($ADD OR $EDIT){
				...
				echo $CI->forms->form_fields('text','brandName',$brandVal,'ADD BRAND NAME','r');
					...
					<?php 
						...
						foreach($status as $s)
						{
							...
							echo "<tr>";
								...
								echo "<td $c >". $brandName ."</td>";
								echo "<td $c style='text-align:center;'>";
								if($EDIT)
									echo "<a href='".HTTP_PATH."itemDatabase/brands/edit/".$id."'>Edit</a> |"; 
								if($DELETE)	
	...
	<script type="text/javascript">
		...
		{
			jConfirm("Are you sure you want to delete this Brand?","Alert",function(r){
				if(r) window.location = "<?php echo HTTP_PATH ?>itemDatabase/brands/deleteOneItem/"+ id;
			});
		}
		
		function deleteSelectedItem()
		{
			jConfirm("Are you sure you want to delete multiple Brands?","Alert",function(r){
