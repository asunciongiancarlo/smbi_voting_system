<div class="content">
	...
	<div class="working_area">
		...
		<div class='fl ' style='width:100%;margin-top:-12px;'>
		    <form name='BU_activeness' style="margin: 10px 10px 10px 10px;" action='<?php echo HTTP_PATH ."report/item_summary/$tab" ?>' method='post'>
			<?php 
			$opt = array(
						array('val'=>'cName',   		'label'=>'Country'),
						searchParam($tab),
						array('val'=>'uploaded',  		'label'=>'Uploaded Items'),
						array('val'=>'published',  		'label'=>'Published Items'),
						array('val'=>'for_approval',  	'label'=>'For Approval'),
			...
			?>
			   <div style='clear:both;'></div>
			   	<table id="large" cellpadding="0" cellspacing="0" border=1 style="width:100%;font-size:13px;margin-bottom: 5px;" class="iLike_Result_Table tablesorter">
					<?php 
						$Tbl_rows = array(
						array('t'=>'POSM_STATUS',   'label'=>'POSM STATUS',   'link'=>HTTP_PATH.'report/item_summary/POSM_STATUS' ),
						array('t'=>'POSM_TYPE',     'label'=>'POSM TYPE',     'link'=>HTTP_PATH.'report/item_summary/POSM_TYPE'),
						array('t'=>'OUTLET_TYPE',   'label'=>'OUTLET TYPE',   'link'=>HTTP_PATH.'report/item_summary/OUTLET_TYPE'),
						array('t'=>'PREMIUM_TYPE',  'label'=>'PREMIUM TYPE',  'link'=>HTTP_PATH.'report/item_summary/PREMIUM_TYPE'),
						array('t'=>'MATERIAL_TYPE', 'label'=>'MATERIAL TYPE', 'link'=>HTTP_PATH.'report/item_summary/MATERIAL_TYPE'),
						array('t'=>'BRAND_TYPE',    'label'=>'BRAND TYPE',    'link'=>HTTP_PATH.'report/item_summary/BRAND_TYPE'));
				...
				<tbody>
				 <?php 
					...
					echo "<tr style='height: 30px;'>
							...
							<th class='darkTable' style='width:64px;text-align:center;color:white;padding:0px;border-top-style: hidden;' bgcolor='#370909'>     <b>For Approval       </b></th> 
							<th class='darkTable' style='width:64px;text-align:center;color:white;padding:0px;border-top-style: hidden;' bgcolor='#370909'>     <b>Disapprove       </b></th> 
							<th class='darkTable' style='width:64px;text-align:center;color:white;padding:0px;border-top-style: hidden;' bgcolor='#370909'>     <b>Published Items    </b></th> 
					...
					$sub_total_Upload 	 	= 0;
					$sub_total_Published 	= 0;
					$sub_total_For_Approval = 0;
					$sub_total_Disapprove   = 0;
					$sub_total_myViews 		= 0;
					$sum_total_Upload		= 0;
					$sum_total_Published	= 0;
					$sum_total_For_Approval	= 0;
					$sum_total_Disapprove	= 0;
					$sum_total_myViews	= 0;
					$x = 0;	
					//print_r($rows);
					$f="";
					...
					echo "<tr>
						   ...
						   <td   style='text-align:right;padding-right:20px;'><b>$sub_total_For_Approval</b></td>
						   <td   style='text-align:right;padding-right:20px;'><b>$sub_total_Disapprove</b></td>
						   <td   style='text-align:right;padding-right:20px;'><b>$sub_total_Published</b></td>
						   <td   style='text-align:right;padding-right:20px;'><b>$sub_total_myViews</b></td>
						   ";
					if($ctr==1)
						echo "<td   style='text-align:center;padding-right:20px;'></td>";
					else
						echo "<td   style='text-align:center;padding-right:20px;'></td>";
					...
					$sub_total_Published 	+= $Published_Items;
					$sub_total_For_Approval += $For_Approval;
					$sub_total_Disapprove += $Disapprove_Items;
					$sub_total_myViews += $myViews;
					
					$sum_total_Upload       += $Uploaded_Items;
					$sum_total_Published    += $Published_Items;
					$sum_total_For_Approval += $For_Approval;
					$sum_total_Disapprove += $Disapprove_Items;
					$sum_total_myViews += $myViews;
				 ...
				 "<tr>
				  ...
				  <td $c style='text-align:right;padding-right:20px;'>	$For_Approval      </td>
				  <td $c style='text-align:right;padding-right:20px;'>	$Disapprove_Items      </td>
				  <td $c style='text-align:right;padding-right:20px;'>	$Published_Items   </td>
				  <td $c style='text-align:right;padding-right:20px;'>	$myViews      </td>
				  <td $c style='text-align:center;padding-right:20px;'>	<a href='".HTTP_PATH."report/item_summary_details/$cID/$fld/$fldID/$DateFrom/$DateTo'>Details</a> </td>
				</tr>";
				 }
				 if(count($rows)>=2 AND $sa==TRUE){
				 echo "<tr>
						   <td style='text-align:left;padding-left:30px;'>	<b>Sub Total</b></td>
						   <td></td>		  			  		  			  
						   <td> </td>		  			  		  			  
				 ...
				 echo "<tr>
					   ...
					   <td class='alter' style='text-align:right;padding-right:20px;'><b>$sum_total_For_Approval</b></td>
					   <td class='alter' style='text-align:right;padding-right:20px;'><b>$sum_total_Disapprove</b></td>
					   <td class='alter' style='text-align:right;padding-right:20px;'><b>$sum_total_Published</b></td>
					   <td class='alter' style='text-align:right;padding-right:20px;'><b>$sum_total_myViews</b></td>
				...
				if(empty($rows)){
					echo "<tr>
							<td colspan='9'> No match found, please review your search parameters.  </td>
						  </tr>";
				}
				?>
				</tbody>	
