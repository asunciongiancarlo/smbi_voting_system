<div class="content">
	...
	<div class="title-content">
		<h2>AVERAGE PRICE PER BUSINESS UNIT</h2>
	</div>
			   ...
			   <?php 
				...
				<tr>
				  ...
				  <td style='text-align:center;'>				
					<a href='<?php echo HTTP_PATH."report/items_price/GroupByCountry_Price/$cID/null/null "; ?>' style='cursor:pointer;'> View Items </a> |
					<a href='<?php echo HTTP_PATH."report/AVG_Price_per_Year/$cID"; ?>' style='cursor:pointer;'> More </a>
				  </td>
				</tr>
				 <?php } ?>
				</tbody>
