    <div class="content">
    	...
    	<div class="fl title-content">
        	<h2><span style='text-transform:lowercase;'>e</span>CATALOGUE: ITEM TYPE - OTHER FIELDS</h2>
        </div>
        ...
        <div class="working_area">
			...
			<?php
				...
				//ISSET ID
				$countryVal="";
				$action = HTTP_PATH ."users/eCatalogue_Type_Other_fields/insert";
			...
			<form name="SMBi2" id="statusTable" action="<?php echo HTTP_PATH ?>itemDatabase/Country/deleteSelectedItem" method="POST"> 
				...
				<table cellpadding="0" cellspacing="0" style="width:100%;margin: 0px auto;">
					...
					<?php 
						...
						$x=0;
						foreach($ecitemType_POSM_table_fields as $s)
						{
							$c = (($x++)%2) == 0 ? "class='alter'" :  ""; 
							extract($s);
							echo "<tr>";
	...
	<script type="text/javascript">
		function deleteOneItem(id)
		{
			...
			{
				window.location = "<?php echo HTTP_PATH ?>users/eCatalogue_Type_Other_fields/deleteOneItem/"+ id;
			}
		}
