<div class="content">
	...
	<div class="title-content">
		<h2><span style='text-transform:lowercase;'>e</span>Catalogue Item Summary</h2>
	</div>
	...
	<div class="working_area">
		...
		<div class='fl ' style='width:100%;margin-top:-12px;'>
		    <form name='BU_activeness' style="margin: 10px 10px 10px 10px;" action='<?php echo HTTP_PATH ."report/item_summary_eCatalogue/$tab" ?>' method='post'>
			<?php 
			$opt = array(
						array('val'=>'ecName',   		'label'=>'Catalogue'),
						searchParam($tab),
						array('val'=>'uploaded',  		'label'=>'Uploaded Items'),
						array('val'=>'views',  		'label'=>'Views')
						);
			...
			if(!isset($val1)) $val1='';
			?>
			<input type='text' name='val1' value="<?php echo $val1; ?>" style='margin-right:10px;width: 164px;'>
			...
			echo "Released From: <input type='text' name='DateFrom' value='$DateFrom'  id='datepicker'  style='width:85px;margin-right:10px;'>";
			echo "Released To: <input type='text' name='DateTo'     value='$DateTo'    id='datepicker2' style='width:85px;'>";
			...
			if(!isset($val2)) $val2='';
			?>
			<input type='text' name='val2' value="<?php echo $val2; ?>" style='margin-right:10px;width: 164px;'>	
		    ...
		    <div style='font-weight:bold; margin-left:17px;margin-top: -104px;'>
			 <?php echo $quarterStr; ?>
			</div>
			</form>
			<?php 
			...
			?>
			   <div style='clear:both;'></div>
			   	<table id="large" cellpadding="0" cellspacing="0" border=1 style="width:100%;font-size:13px;margin-bottom: 5px;" class="iLike_Result_Table tablesorter">
					<?php 
						$Tbl_rows = array(
						array('t'=>'POSM_TYPE',     'label'=>'POSM TYPE',     'link'=>HTTP_PATH.'report/item_summary_eCatalogue/POSM_TYPE'),
						array('t'=>'OUTLET_TYPE',   'label'=>'OUTLET TYPE',   'link'=>HTTP_PATH.'report/item_summary_eCatalogue/OUTLET_TYPE'),
						array('t'=>'PREMIUM_TYPE',  'label'=>'PREMIUM TYPE',  'link'=>HTTP_PATH.'report/item_summary_eCatalogue/PREMIUM_TYPE'),
						array('t'=>'MATERIAL_TYPE', 'label'=>'MATERIAL TYPE', 'link'=>HTTP_PATH.'report/item_summary_eCatalogue/MATERIAL_TYPE'));
				...
				<tbody>
				 <?php 
					...
					echo "<tr style='height: 30px;'>
							...
							<th class='darkTable' style='width:10px;text-align:center;color:white;padding:0px;border-top-style: hidden;' bgcolor='#370909'>   	 <b>Catalogue 		  	  </b></th> 
					...
					echo "<tr>
						   ...
						   <td   style='text-align:right;padding-right:20px;'><b>$sub_total_Views</b></td>";
					echo  "</tr>";
					$sub_total_Upload 	 	= 0;
					$sub_total_Views 	 	= 0;
					$x=1;
					...
					$sub_total_Views 		+= $Views;
					$sum_total_Upload       += $Uploaded_Items;
					$sum_total_Views        += $Views;
				 echo 
				 "<tr>
				  <td $c >												$x   			   </td>
				  <td $c style='text-align:left;padding-left:20px;'>	$Catalogue_Name      </td>
				  <td $c style='text-align:left;padding-left:20px;'>	$fldVal     	   </td>
				  <td $c style='text-align:right;padding-right:20px;'>	$Uploaded_Items    </td>
				  <td $c style='text-align:right;padding-right:20px;'>	$Views    </td>
				  <td $c style='text-align:center;padding-right:20px;'>	<a href='".HTTP_PATH."report/item_summary_eCatalogue_details/$ecID/$fld/$fldID/$DateFrom/$DateTo'>Details</a> </td>
				</tr>";
				 }
				 ...
				 echo "<tr>
					   ...
					   <td class='alter' style='text-align:right;padding-right:20px;'><b>$sum_total_Views</b></td>
