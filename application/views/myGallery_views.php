<div class="content">
	...
	<div class="title-content">
		<h2> Number of Views from My Gallery  </h2>
	</div>
	...
	<div class="working_area">
		...
		<div class='fl ' style='width:100%;margin-top:-12px;'>
		    <form name='BU_activeness' style="margin: 10px 10px 10px 10px;" action='<?php echo HTTP_PATH ."report/myGallery_views/$tab" ?>' method='post'>
			<?php 
			$opt = array(
			...
			?>
			   <div style='clear:both;'></div>
			   	<table id="large" cellpadding="0" cellspacing="0" border=1 style="width:100%;font-size:13px;margin-bottom: 5px;" class="iLike_Result_Table tablesorter">
					<?php 
						$Tbl_rows = array(
						array('t'=>'POSM_STATUS',   'label'=>'POSM STATUS',   'link'=>HTTP_PATH.'report/myGallery_views/POSM_STATUS' ),
						array('t'=>'POSM_TYPE',     'label'=>'POSM TYPE',     'link'=>HTTP_PATH.'report/myGallery_views/POSM_TYPE'),
						array('t'=>'OUTLET_TYPE',   'label'=>'OUTLET TYPE',   'link'=>HTTP_PATH.'report/myGallery_views/OUTLET_TYPE'),
						array('t'=>'PREMIUM_TYPE',  'label'=>'PREMIUM TYPE',  'link'=>HTTP_PATH.'report/myGallery_views/PREMIUM_TYPE'),
						array('t'=>'MATERIAL_TYPE', 'label'=>'MATERIAL TYPE', 'link'=>HTTP_PATH.'report/myGallery_views/MATERIAL_TYPE'),
						array('t'=>'BRAND_TYPE',    'label'=>'BRAND TYPE',    'link'=>HTTP_PATH.'report/myGallery_views/BRAND_TYPE'));
				...
				<tbody>
				 ...
				 "<tr>
				  ...
				  <td $c style='text-align:center;padding-right:20px;'>	<a href='".HTTP_PATH."report/myGallery_details/$cID/$fld/$fldID/$DateFrom/$DateTo'>Details</a> </td>
				</tr>";
				 }
