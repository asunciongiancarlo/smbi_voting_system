<div class="content" style="width: 112%;margin-left: -6%;"> 
	...
	<div class="title-content">
		<h2> Number of Views from My Gallery in Details</h2>
	</div>
	...
	<div class="working_area" style="min-height:816px;">
		...
		//print_r($POST);
		?>
		   <form name="SMBi2" id="statusTable" action='<?php echo HTTP_PATH."report/myGallery_details/$cID/$fieldName/$fieldVal/$DateFrom/$DateTo" ?>' method="POST"> 
