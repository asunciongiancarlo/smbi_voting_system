<div class="content" style="width: 112%;margin-left: -6%;">
	...
	<div class="title-content">
		<h2>ACTIVENESS OF USERS IN DETAILS</h2>
	</div>
	...
	<div class="working_area" style="min-height:816px;">
		...
		//print_r($POST);
		?>
		  <form name="SMBi2" id="statusTable" action='<?php echo HTTP_PATH."report/BU_activeness_Users_details/$cID/$userID/$DateFrom/$DateTo" ?>' method="POST">
		  ...
		  <?php 
		   if($limit+20 <= $totrec) 
			...
			<div style='font-weight:bold;'>
			 <?php echo "$country_name | User: $full_name | $quarterStr"; ?>
			 </div>
