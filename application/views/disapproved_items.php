<div class="content" style='padding-left:1px;'>
	<div class="title-content" style='width:100%;'>
		<h2  class="item-galla" style='width:40%;float:left;'><span>Disapproved Items</span></h2>
	...
	<div>
		...
		<div  style="font-weight:bold; font-size:15px;" class="container">
			...
			?>
			<div class="row1 rowitems">
			<form name="SMBi2" id="itemsForm" action="<?php echo HTTP_PATH ?>itemDatabase/tag_for_purging/disapproved_items/purgeSelectedItems" method="POST"> 
			
			<?php 		
				if(!empty($data) & $DELETE & $_SESSION['super_admin']!='y'){ 
				...
				echo $csrf;
					...
					<div class="common-gal fl items-item" style='border:1px solid #999999;min-height:280px;overflow:hidden;'>
						...
						<div class="common-gal-heading" style='text-align:center;height:25px;color:white;font-style:bold;margin-bottom:3px;<?php echo $background ?>' <?php echo $title ?>> 
							...
							<?php if($publish!='y'){ echo "<br/><label style='font-size:11px;color:red;margin-top:-3px;'>*Disapproved Item</label>"; } ?>
						</div>
						<div class="clear"></div>
						 ...
						 echo "<label style='font-size:10px;text-align:center;margin-bottom:-15px;'>" ;
								...
								if(($EDIT & $_SESSION['super_admin']!='y') OR ($VENDORS_EDIT & $_SESSION['super_admin']!='y'))	
									echo "<a href='".HTTP_PATH."itemDatabase/disapproved_items/edit/".$itemID."/disapproved_items'>Edit</a> |";
	...
	<script type="text/javascript">
		...
		function deleteOneItem(id)
		{
			jConfirm("Are you sure you want to submit this item for purging?","Alert",function(r){
				if(r) window.location = "<?php echo HTTP_PATH ?>itemDatabase/tag_for_purging/disapproved_items/purgeOneItem/"+ id;
			});
		}
		...
		{
			jConfirm("Are you sure you want to submit these multiple Items for purging?","Alert",function(r){
