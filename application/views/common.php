<div>
 <?php 
	...
	?>	
		<div class="common-gal fl gallery-item" style='height:298px;overflow:hidden;'>
			<div class="common-gal-heading" style='text-align:center;height:25px;background:#999999;color:white;font-style:bold;'> <b><?php echo $POSM_TypeName; ?></b> 
			...
			<div class="clear"></div>
			 ...
			 <div class="clear"  style='border-bottom:1px solid #eeeeee;height:160px;text-align:center;width:210px;overflow:hidden'>
				<table>
				 <tr>
					<td class='gal-Icon-Container'><a href="<?php echo HTTP_PATH.'gallery/itemInfo2/'.$itemID .'/c' ?>"> <img class='gal-Icon-Img' src="<?php echo HTTP_PATH?>img/galleryImg/<?php echo $item_img ?>" style='<?php echo $w ?>'></a></td>
				</tr>	
				</table> 
			 </div>
			 <div style='text-align:center;'>
				<hr style='margin:2px 0'>
				<h4 class='ptitle' id='pt<?php echo $itemID ?>' alt='' title="<?php echo $itemName?>" style='font-size:15px;'>
				<?php 
				...
				<p style='color:#555;height:20px;margin-bottom:1px;margin-top: -9px;font-size:12px;'><?php echo $countryName ?></p>
...
<?php
 ...
 echo "<b style='font-size:12px;clear:both;'>Featured Brands:</b><ul class='featured_brands_ul'>"; 
 foreach($featured_brands as $fb){
  extract($fb);
  echo "<li class='featured_brands_li'>$brandName</li>";
 }
 echo "</ul>";
?>
<div style='clear:both'></div>
			<div style="text-align:center;font-weight:normal;margin-left:-75px;margin-top: -79px;">
			<?php if($last>0){ 
				$url_append = $url;
			?>	
				<ul class="pagination" style="margin-left:40px;">
					<a href="<?php echo HTTP_PATH ."gallery/redirect_link/$redirectTo/page/1/".$url_append ?>"><li class="page-btn firstnum" style="margin-right:3px;"> &laquo; FIRST </li></a> 
						<?php 
							//PAGNINATION
							...
							if($active_page<=9){
								...
								while($l!=0)
								{
									...
									if($page-1<=$last){
										...
										$url1 = HTTP_PATH. "gallery/redirect_link/$redirectTo/page/".$ctr++."/".$url_append; 
								...
								$style="style='margin-right:2px;'";
								while($i!=0){
									$url2 = HTTP_PATH. "gallery/redirect_link/$redirectTo/page/".$page++."/".$url_append; 
									echo  "<a href='$url2' $style><li>". $page1++ ."</li></a>";
								 $i--;
								}
								
								/*ACTIVE PAGE*/
								$url3 = HTTP_PATH. "gallery/redirect_link/$redirectTo/page/".$active_page."/".$url_append; 
								...
								while($i!=0){
								  if(($active_page++)<$last){
									 $url4 = HTTP_PATH. "gallery/redirect_link/$redirectTo/page/".$page++."/".$url_append; 
							...
							$url5 = HTTP_PATH. "gallery/redirect_link/$redirectTo/page/$last/".$url_append; 
						?>
