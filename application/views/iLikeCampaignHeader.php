...
<div class="container" >
    ...
    <div class="breadcrums" style='cursor:pointer;'>
    	<ul>
        	<li><a onclick="cleariLikeSessionItems(this,'<?php echo HTTP_PATH ?>')"> Home </a></li>
			<li><img src="<?php echo HTTP_PATH ?>img/arrow.png" width="3" height="5"></li>
			<li><a onclick="cleariLikeSessionItems(this,'<?php echo HTTP_PATH."iLikeCampaign/votingCampaign/" ?>')"> iLike Campaign </a></li>
     	</ul>
  	</div>
...
<script>
	//document.getElementById('campaignDiv').oncontextmenu = function(){ return false; }
