			...
			<div id="tabs" style="font-size:14px;width:96%;"> <!-- margin-left:-75px; -->
				  ...
				  <div id="tabs-1" style="padding-left:50px;">
					<!-- ITEM FORM -->
						...
						else 							$released_Date = convertDate('date',"$released_Date 00:00:00");
						
						$uploaded_Date = convertDate('date',"$uploaded_Date 00:00:00");
						  ...
						  <table width="100%" cellpadding="0" cellspacing="0" border="0" >
							 <td rowspan="10" width="50%" valign='top'>
							  <center>
								...
								<div class='ul_logs'>";
								foreach($restore_history as $rh){
								extract($rh);
								echo "<p class='itm_log'><strong>Restored from Disk By: </strong> $full_name ($tdate)</p>"; 
								}
								foreach($archive_history as $ah){
								extract($ah);
								echo "<p class='itm_log'><strong>Restored from Archive By: </strong> $full_name ($tdate)</p>"; 
								}
								foreach($purging_history as $ph){
								extract($ph);
								echo "<p class='itm_log'><strong>Restored from Purging By: </strong> $full_name ($tdate)</p>"; 
								}
								echo "</div>";
								echo "<div style='clear:both'></div>
								<div class='ul_logs'>";
							 ...
							 <div id="accordion" style="width:80%;">
								<h3 style='height: 11px;color:#710002;'><b>ITEM INFORMATION</b></h3>
								  <div>
									...
									if(isset($item[0])){
										...
										//USD PRICE RANGE
										if($CI2->fv->fieldChecker($POSMStatusID,31)=='y'){
											echo "<strong> ". $CI2->fv->label(86) ." </strong>:<br/>"; 
											if($level_name!="" AND $extra_label!="") echo "$level_name: $extra_label <br/>";
										}
										//Estimated lead time
								...
								<div>
									...
									<form name='inquiryFORM' id='inquiryFORM'>
										<textarea rows="3"  cols="10" name="message" id="message" class="messageCommentBox"></textarea><br/>
