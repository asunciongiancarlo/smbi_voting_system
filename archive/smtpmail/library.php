...
define("SMTP_UNAME", "sanmiguelbeer.international@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "sanmiguelbeer"); //Password for SMTP authentication
